...
function mojHangar(props) {
    ...
    const PrikaziKartice = (card) => {
        if (card.modelNum === null) {
            return (
                <div class="bg-gradient-to-r from-slate-200 to-stone-400 block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                    ...
                    <p class="pt-5 font-normal text-gray-700 dark:text-gray-400">Opis: Nije istraženo!</p>
                    <p class="pt-8 font-normal text-gray-700 dark:text-gray-400">Broj proizvedenih modela: Nije istraženo!</p>
                </div>
            );
        } else if (card.modelNum > 9000) {
            return (
    ...
    return (
        <For each={cards()} 
            fallback={<tr><td colspan="7" class="text-center py-4">Vaš hangar je prazan!</td></tr>}
        >
